...
<head>
	...
	<script type="text/javascript">
		function delete_record(id)
		{
			...
			{
				window.location.href='delete_detailing.php?id='+id;
			}
		}
		function booked_record(id)
		{
			...
			{
				window.location.href='bookeddiverifdetailing.php?id='+id;
			}
		}
		function booking_record(id)
		{
			...
			{
				window.location.href='canceldiverifdetailing.php?id='+id;
			}
		}
	</script>
</head>
		...
		<div class="container">
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Car Detailing Request</h3>
							</div>
							<div class="module-body table">
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									<thead>
										<tr>
											<th>Detailing Type</th>
											<th>Customer Name</th>
											<th>Phone Number</th>
											<th>Date and Time</th>
											<th>Status</th>
	        ...
	        while($row = $result->fetch_object()){
	          ...
	          if ($row->status=='Booked'){
				...
				echo '<a href="edit_detailing.php?id='.$row->id.'">Edit<br></a>';
