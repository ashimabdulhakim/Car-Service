...
<head>
	...
	<script type="text/javascript">
		function delete_record(id)
		{
			...
			{
				window.location.href='delete_coating.php?id='+id;
			}
		}
		function booked_record(id)
		{
			...
			{
				window.location.href='bookeddiverifcoating.php?id='+id;
			}
		}
		function booking_record(id)
		{
			...
			{
				window.location.href='canceldiverifcoating.php?id='+id;
			}
		}
	</script>
</head>
		...
		<div class="container">
	        ...
	        while($row = $result->fetch_object()){
	          ...
	          if ($row->status=='Booked'){
				...
				echo '<a href="edit_coating.php?id='.$row->id.'">Edit<br></a>';
