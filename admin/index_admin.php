...
<head>
	...
	<script type="text/javascript">
		function delete_record(id)
		{
			...
			{
				window.location.href='delete_wash.php?id='+id;
			}
		}
		function booked_record(id)
		{
			...
			{
				window.location.href='bookeddiverif.php?id='+id;
			}
		}
		function booking_record(id)
		{
			...
			{
				window.location.href='canceldiverif.php?id='+id;
			}
		}
	</script>
</head>
		...
		<div class="container">
	        ...
	        while($row = $result->fetch_object()){
	          ...
	          if ($row->status=='Booked'){
				echo '<td>';
				echo '<a href="javascript:booking_record('.$row->id_wash.')">Cancel<br></a>';
				echo '<a href="edit_wash.php?id='.$row->id_wash.'">Edit<br></a>';
				echo '<a href="javascript:delete_record('.$row->id_wash.')">Delete</a>';
				echo '</td>';
			}else {
				echo '<td>';
				echo '<a href="javascript:booked_record('.$row->id_wash.')">Approved<br></a>';
				echo '<a href="edit_wash.php?id='.$row->id_wash.'">Edit<br></a>';
				echo '<a href="javascript:delete_record('.$row->id_wash.')">Delete</a>';
				echo '</td>';
			}
